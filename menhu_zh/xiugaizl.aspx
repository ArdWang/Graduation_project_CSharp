<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xiugaizl.aspx.cs" Inherits="xiugaizl" %>
...
<body>
    <form id="form1" runat="server">
       <div id="box">
           <div id="top">
               <span class="zt1">W蓝科技-修改资料</span><br/><span class="zt3"> management system of information media</span>
           </div>
           <div id="middle">
               <div id="reg">
                   <div class="top3">
                       <span class="syzt1">修改资料-Modifiying Personal Infromation</span>
                   </div>
                   <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                   <div class="con1">
                      <table>
                           <tr><td style="text-align:right; width:250px;"><span class="zt2">用户名：</span></td><td style="text-align:left; width:130px;">
                               <asp:Label ID="lbname" runat="server" Text="Label"></asp:Label></td><td style="text-align:left;">&nbsp;</td></tr>
                           <tr><td style="text-align:right; width:250px;"><span class="zt2">密码：</span></td><td style="text-align:left; width:130px;">
                               <asp:TextBox ID="password" runat="server" Width="120px"></asp:TextBox></td><td style="text-align:left;"><span class="zt6">*<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="password" Display="Dynamic" ErrorMessage="密码不能为空"></asp:RequiredFieldValidator>
                                   </span></td></tr>
                           ...
                           <tr><td colspan="2" style="text-indent:180px;">
                               <asp:Button ID="Regs" runat="server" Text="修改" Width="50" ForeColor="#0000CC" OnClick="Regs_Click" /></td><td>
                                   <asp:Button ID="Rept" runat="server" Text="返回" ForeColor="#0000CC" Width="50px" CausesValidation="False" OnClick="Rept_Click" /></td></tr>
                       </table>
                   </div>
