<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="plms_edit.aspx.cs" Inherits="admin_plms_edit" ValidateRequest="false" %>
...
<div class="left">
        <div class="l_top">美食评论管理</div>
        <div class="l_con">
           <ul>
              <li><a href="plms_add.aspx">评论发布</a></li>
              <li><a href="plms_edit.aspx">评论编辑</a></li>
           </ul>
        </div>
    </div>
</asp:Content>
   ...
   <div class="right">
       ...
       <div class="r_con">
          <asp:GridView ID="grdgypl" runat="server" AutoGenerateColumns="False" 
               ...
               onrowupdating="grdgypl_RowUpdating" DataKeyNames="plmsID" 
               onrowdeleting="grdgypl_RowDeleting">
           <Columns>
               <asp:TemplateField HeaderText="评论文章ID">
                   <EditItemTemplate>
                       <asp:Label ID="lbid1" runat="server" Text='<%# Eval("msID") %>'></asp:Label>
                   </EditItemTemplate>
                   <ItemTemplate>
                       <asp:Label ID="lbid" runat="server" Text='<%# Bind("msID") %>'></asp:Label>
                   </ItemTemplate>
               ...
               <asp:TemplateField HeaderText="删除" ShowHeader="False">
                   <ItemTemplate>
                       <asp:LinkButton ID="lbtndel" runat="server" CausesValidation="False" 
                           CommandName="Delete" Text="删除" CommandArgument='<%# Eval("plmsId") %>' 
