...
public partial class admin_plsd_add : System.Web.UI.Page
{
    ...
    {
        string sql = "select sdid from sy_study";
    ...
    protected void btnfb_Click(object sender, EventArgs e)
    {
        ...
        if (sybll.Insert_sdpl(gyid, name, con) > 0)
        {
            sybll.Update_addsdpl(gyid);
