<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="plyx_edit.aspx.cs" Inherits="admin_plyx_edit" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <div class="right">
       <div class="r_top">游戏评论编辑</div>
       <div class="r_con">
          <asp:GridView ID="grdyxpl" runat="server" AutoGenerateColumns="False" 
               onrowediting="grdyxpl_RowEditing" 
               onrowcancelingedit="grdyxpl_RowCancelingEdit" 
               onrowupdating="grdyxpl_RowUpdating" DataKeyNames="plyxID" 
               onrowdeleting="grdyxpl_RowDeleting">
           <Columns>
               <asp:TemplateField HeaderText="评论文章ID">
                   <EditItemTemplate>
                       <asp:Label ID="lbid1" runat="server" Text='<%# Eval("gameID") %>'></asp:Label>
                   </EditItemTemplate>
                   <ItemTemplate>
                       <asp:Label ID="lbid" runat="server" Text='<%# Bind("gameID") %>'></asp:Label>
                   </ItemTemplate>
               ...
               <asp:TemplateField HeaderText="删除" ShowHeader="False">
                   <ItemTemplate>
                       <asp:LinkButton ID="lbtndel" runat="server" CausesValidation="False" 
                           CommandName="Delete" Text="删除" CommandArgument='<%# Eval("plyxId") %>' 
