<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="plyl_edit.aspx.cs" Inherits="admin_plyl_edit" ValidateRequest="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="left">
        <div class="l_top">娱乐评论管理</div>
        <div class="l_con">
           <ul>
              <li><a href="plyl_add.aspx">评论发布</a></li>
              <li><a href="plyl_edit.aspx">评论编辑</a></li>
           </ul>
        </div>
    </div>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <div class="right">
       <div class="r_top">娱乐评论编辑</div>
       <div class="r_con">
          <asp:GridView ID="grdylpl" runat="server" AutoGenerateColumns="False" 
               onrowediting="grdylpl_RowEditing" 
               onrowcancelingedit="grdylpl_RowCancelingEdit" 
               onrowupdating="grdylpl_RowUpdating" DataKeyNames="plylID" 
               onrowdeleting="grdylpl_RowDeleting">
           <Columns>
               <asp:TemplateField HeaderText="评论文章ID">
                   <EditItemTemplate>
                       <asp:Label ID="lbid1" runat="server" Text='<%# Eval("yuleID") %>'></asp:Label>
                   </EditItemTemplate>
                   <ItemTemplate>
                       <asp:Label ID="lbid" runat="server" Text='<%# Bind("yuleID") %>'></asp:Label>
                   </ItemTemplate>
               ...
               <asp:TemplateField HeaderText="删除" ShowHeader="False">
                   <ItemTemplate>
                       <asp:LinkButton ID="lbtndel" runat="server" CausesValidation="False" 
                           CommandName="Delete" Text="删除" CommandArgument='<%# Eval("plylId") %>' 
