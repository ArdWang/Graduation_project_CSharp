<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="admin_xy.aspx.cs" Inherits="admin_xy" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <div class="right">
   <div class="r_top">校园内容</div>
   <div class="r_con">
       <asp:GridView ID="grdxy" runat="server" AutoGenerateColumns="False" EnableModelValidation="True">
           <Columns>
               <asp:TemplateField HeaderText="校园ID">
                   <EditItemTemplate>
                       <asp:TextBox ID="txtxybt" runat="server" Text='<%# Bind("xyId") %>'></asp:TextBox>
                   </EditItemTemplate>
                   <ItemTemplate>
                       <asp:Label ID="Label1" runat="server" Text='<%# Bind("xyId") %>'></asp:Label>
                   </ItemTemplate>
                   <ItemStyle CssClass="t1" />
               </asp:TemplateField>
               <asp:TemplateField HeaderText="校园标题">
                   <EditItemTemplate>
                       <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("xyTitle") %>'></asp:TextBox>
                   </EditItemTemplate>
                   <ItemTemplate>
                       <asp:Label ID="Label2" runat="server" Text='<%# Bind("xyTitle") %>'></asp:Label>
                   </ItemTemplate>
                   <ItemStyle CssClass="t2" />
               </asp:TemplateField>
               <asp:TemplateField HeaderText="校园内容">
                   <EditItemTemplate>
                       <asp:TextBox ID="txtxycon" runat="server" Text='<%# Bind("xyCon") %>'></asp:TextBox>
                   </EditItemTemplate>
                   <ItemTemplate>
               ...
               <asp:TemplateField HeaderText="校园图片">
                   <EditItemTemplate>
                       <asp:TextBox ID="txtxyimg" runat="server" Text='<%# Bind("xyImg") %>'></asp:TextBox>
                   </EditItemTemplate>
                   <ItemTemplate>
               ...
               <asp:TemplateField HeaderText="发布人">
                   <EditItemTemplate>
                       <asp:TextBox ID="txtfbman" runat="server" Text='<%# Bind("xyFbman") %>'></asp:TextBox>
                   </EditItemTemplate>
                   <ItemTemplate>
               ...
               <asp:TemplateField HeaderText="发布时间">
                   <EditItemTemplate>
                       <asp:TextBox ID="txtfbtime" runat="server" Text='<%# Bind("xyTime") %>'></asp:TextBox>
                   </EditItemTemplate>
                   <ItemTemplate>
               ...
               <asp:TemplateField HeaderText="评论">
                   <EditItemTemplate>
                       <asp:TextBox ID="txtxypl" runat="server" Text='<%# Bind("xypl") %>'></asp:TextBox>
                   </EditItemTemplate>
                   <ItemTemplate>
