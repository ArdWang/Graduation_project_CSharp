<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xy_add.aspx.cs" Inherits="admin_xy_add" ValidateRequest="false" %>
    ...
    <form id="form1" runat="server">
       <div id="box">
        ...
        <div class="main">
            ...
            <div class="m_right">
               <div class="mr_top">校园内容发布</div>
               <div class="mr_con">
                  <div class="bt">
                      <div class="bt_top">校园标题</div>
                      <div class="bt_con">
                          <asp:TextBox ID="txtxybt" runat="server" Width="400px" Height="40px"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="标题不能为空" Display="Dynamic" ControlToValidate="txtxybt"></asp:RequiredFieldValidator>
                      </div>
                  </div>
                  <div class="nr">
                      <div class="nr_top">校园内容(必填)&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="内容不能为空" ControlToValidate="content1" Display="Dynamic"></asp:RequiredFieldValidator></div>
                      <div class="nr_con">
                          <textarea id="content1" cols="100" rows="8" style="width:500px;height:170px;visibility:hidden;" runat="server"></textarea>
                      </div>
                  </div>
                  <div class="Img">
                      <div class="im_top">校园照片</div>
                      <div class="im_con">
