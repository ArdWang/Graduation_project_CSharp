...
public partial class admin_plly_add : System.Web.UI.Page
{
    ...
    {
        string sql = "select lyid from sy_lyou";
    ...
    protected void btnfb_Click(object sender, EventArgs e)
    {
        ...
        if (sybll.Insert_lypl(gyid, name, con) > 0)
        {
            sybll.Update_addlypl(gyid);
