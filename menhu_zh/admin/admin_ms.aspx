<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="admin_ms.aspx.cs" Inherits="admin_admin_ms" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <div class="right">
   <div class="r_top">美食内容</div>
   <div class="r_con">
       <asp:GridView ID="grdms" runat="server" AutoGenerateColumns="False">
           <Columns>
               <asp:TemplateField HeaderText="美食ID">
                   <EditItemTemplate>
                       <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("msId") %>'></asp:TextBox>
                   </EditItemTemplate>
                   <ItemTemplate>
                       <asp:Label ID="Label1" runat="server" Text='<%# Bind("msId") %>'></asp:Label>
                   </ItemTemplate>
                   <ItemStyle CssClass="t1" />
               </asp:TemplateField>
               <asp:TemplateField HeaderText="美食标题">
                   <EditItemTemplate>
                       <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("msTitle") %>'></asp:TextBox>
                   </EditItemTemplate>
                   <ItemTemplate>
                       <asp:Label ID="Label2" runat="server" Text='<%# Bind("msTitle") %>'></asp:Label>
                   </ItemTemplate>
                   <ItemStyle CssClass="t2" />
               </asp:TemplateField>
               <asp:TemplateField HeaderText="美食内容">
                   <EditItemTemplate>
                       <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("msCon") %>'></asp:TextBox>
                   </EditItemTemplate>
                   <ItemTemplate>
               ...
               <asp:TemplateField HeaderText="图片">
                   <EditItemTemplate>
                       <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("msImg") %>'></asp:TextBox>
                   </EditItemTemplate>
                   <ItemTemplate>
               ...
               <asp:TemplateField HeaderText="发布人">
                   <EditItemTemplate>
                       <asp:TextBox ID="TextBox5" runat="server" Text='<%# Bind("msFbman") %>'></asp:TextBox>
                   </EditItemTemplate>
                   <ItemTemplate>
               ...
               <asp:TemplateField HeaderText="发布时间">
                   <EditItemTemplate>
                       <asp:TextBox ID="TextBox6" runat="server" Text='<%# Bind("msTime") %>'></asp:TextBox>
                   </EditItemTemplate>
                   <ItemTemplate>
               ...
               <asp:TemplateField HeaderText="评论">
                   <EditItemTemplate>
                       <asp:TextBox ID="TextBox7" runat="server" Text='<%# Bind("mspl") %>'></asp:TextBox>
                   </EditItemTemplate>
                   <ItemTemplate>
