...
public partial class admin_plxy_add : System.Web.UI.Page
{
    ...
    {
        string sql = "select xyid from sy_xiaoy";      
    ...
    protected void btnfb_Click(object sender, EventArgs e)
    {
        ...
        if (sybll.Insert_xypl(gyid, name, con) > 0)
        {
            sybll.Update_addxypl(gyid);
