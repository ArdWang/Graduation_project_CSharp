<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ly_add.aspx.cs" Inherits="admin_ly_add" ValidateRequest="false"%>
    ...
    <form id="form1" runat="server">
      <div id="box">
        ...
        <div class="main">
            ...
            <div class="m_right">
               <div class="mr_top">旅游内容添加</div>
               <div class="mr_con">
                  <div class="bt">
                      <div class="bt_top">标题</div>
                      <div class="bt_con">
                          <asp:TextBox ID="txtlybt" runat="server" Width="400px" Height="40px"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="标题不能为空" Display="Dynamic" ControlToValidate="txtlybt"></asp:RequiredFieldValidator>
                      </div>
                  </div>
                  <div class="nr">
