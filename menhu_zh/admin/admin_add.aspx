<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="admin_add.aspx.cs" Inherits="admin_admin_add" %>
      ...
      <table>
        <tr><td style=" width:100px; text-align:right;">用户添加：</td><td style=" width:300px; text-align:left; height:30px;">
            <asp:TextBox ID="txtname" runat="server"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator
                ...
                ControlToValidate="txtname" Display="Dynamic"></asp:RequiredFieldValidator></td></tr>
            ...
            <asp:TextBox ID="txtpwd1" runat="server" TextMode="Password"></asp:TextBox>&nbsp;<asp:CompareValidator 
                ...
                <tr><td style=" width:100px; text-align:right;">说明：</td><td style=" width:300px; text-align:left; height:30px;">
