<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jk_add.aspx.cs" Inherits="admin_jk_add" ValidateRequest="false"%>
...
<body>
    <form id="form1" runat="server">
      <div id="box">
        ...
        <div class="main">
            <div class="m_left">
                <div class="ml_top">健康管理</div>
                <div class="ml_con">
                   <ul>
                      <li><a href="admin_jk.aspx">健康首页</a></li>
            ...
            <div class="m_right">
               <div class="mr_top">健康内容添加</div>
               <div class="mr_con">
                  <div class="bt">
                      <div class="bt_top">标题</div>
                      <div class="bt_con">
                          <asp:TextBox ID="txtjkbt" runat="server" Width="400px" Height="40px"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="标题不能为空" Display="Dynamic" ControlToValidate="txtjkbt"></asp:RequiredFieldValidator>
                      </div>
                  </div>
                  <div class="nr">
