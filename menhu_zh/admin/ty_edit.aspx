<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="ty_edit.aspx.cs" Inherits="admin_ty_edit" ValidateRequest="false" %>
    ...
    <div class="right">
       ...
       <div class="r_con">
          <asp:GridView ID="grdnews" runat="server" AutoGenerateColumns="False" 
               ...
               onrowupdating="grdnews_RowUpdating" DataKeyNames="tyId" 
               onrowdeleting="grdnews_RowDeleting">
           <Columns>
               <asp:TemplateField HeaderText="体育标题">
                   <EditItemTemplate>
                       <asp:TextBox ID="txttybt" runat="server" Text='<%# Bind("tyTitle") %>' 
                           TextMode="MultiLine" Width="80px" Height="190px" CssClass="zt1"></asp:TextBox>
                   </EditItemTemplate>
                   <ItemTemplate>
                       <asp:Label ID="Label2" runat="server" Text='<%# Bind("tyTitle") %>' CssClass="zt1"></asp:Label>
                   </ItemTemplate>
                   <ItemStyle CssClass="t2" />
               </asp:TemplateField>
               <asp:TemplateField HeaderText="体育内容">
                   <EditItemTemplate>
                       <asp:TextBox ID="txttycon" runat="server" Text='<%# Bind("tyCon") %>' 
               ...
               <asp:TemplateField HeaderText="体育图片">
                   <EditItemTemplate>
                     <asp:FileUpload ID="fuimg" runat="server" Width="80px" Height="30px" /><br/>
                       <asp:TextBox ID="txtimg" runat="server" Text='<%# Bind("tyImg") %>' Width="100px" Height="150px"></asp:TextBox>
                   </EditItemTemplate>
                   <ItemTemplate>
               ...
               <asp:TemplateField HeaderText="发布人">
                   <EditItemTemplate>
                       <asp:TextBox ID="txttyman" runat="server" Text='<%# Bind("tyFbman") %>' 
               ...
               <asp:TemplateField HeaderText="发布时间">
                   <EditItemTemplate>
                       <asp:TextBox ID="txttytime" runat="server" onClick="WdatePicker()" Text='<%# Bind("tyTime") %>' 
               ...
               <asp:TemplateField HeaderText="评论">
                   <EditItemTemplate>
                       <asp:TextBox ID="txttypl" runat="server" Text='<%# Bind("typl") %>' 
               ...
               <asp:TemplateField HeaderText="删除" ShowHeader="False">
                   <ItemTemplate>
                       <asp:LinkButton ID="lbtndel" runat="server" CausesValidation="False" 
                           CommandName="Delete" Text="删除" CommandArgument='<%# Eval("tyId") %>' 
