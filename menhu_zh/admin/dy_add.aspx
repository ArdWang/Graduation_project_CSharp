<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dy_add.aspx.cs" Inherits="admin_dy_add" ValidateRequest="false"%>
       ...
       <div id="box">
        ...
        <div class="b_nav">
            <div class="n_left">欢迎回来：<asp:Label ID="lbname" runat="server" Text=""></asp:Label>&nbsp;&nbsp;<asp:LinkButton
                ID="lbexit" runat="server" onclick="lbexit_Click" CausesValidation="False" ForeColor="White">退出</asp:LinkButton></div>
            <div id="n_right">
                <ul>
                    <li><a href="#">后台首页</a></li>
                    <li><a href="#">资讯</a>
        ...
        <div class="main">
            ...
            <div class="m_right">
               <div class="mr_top">电影内容添加</div>
               <div class="mr_con">
                  <div class="bt">
                      <div class="bt_top">电影标题</div>
                      <div class="bt_con">
                          <asp:TextBox ID="txtdybt" runat="server" Width="400px" Height="40px"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="标题不能为空" Display="Dynamic" ControlToValidate="txtdybt"></asp:RequiredFieldValidator>
                      </div>
                  </div>
                  <div class="nr">
                      <div class="nr_top">电影内容(必填)&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="内容不能为空" ControlToValidate="content1" Display="Dynamic"></asp:RequiredFieldValidator></div>
                      <div class="nr_con">
                          <textarea id="content1" cols="100" rows="8" style="width:500px;height:170px;visibility:hidden;" runat="server"></textarea>
                      </div>
                  </div>
                  <div class="Img">
                      <div class="im_top">电影照片</div>
                      <div class="im_con">
                          <asp:FileUpload ID="fuimg" runat="server" /></div>
                  </div>
                  <div class="fbman">
                      <div class="fb_top">电影院</div>
                      <div class="fb_con">
                          <asp:TextBox ID="txtyy" runat="server" Width="160px" Height="20px"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="电影院不能为空" Display="Dynamic" ControlToValidate="txtyy"></asp:RequiredFieldValidator></div>
                  </div>
                  <div class="time">
                      <div class="tm_top">上线时间</div>
                      <div class="tm_con">
                          <asp:TextBox ID="txttime" runat="server" onClick="WdatePicker()" Height="20px" Width="140px"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="电影上线时间不能为空" Display="Dynamic" ControlToValidate="txttime"></asp:RequiredFieldValidator></div>
                  </div>
                  <div class="btn">
