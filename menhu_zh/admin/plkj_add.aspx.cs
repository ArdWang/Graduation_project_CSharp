...
public partial class admin_plkj_add : System.Web.UI.Page
{
    ...
    {
        string sql = "select kjid from sy_keji";
    ...
    protected void btnfb_Click(object sender, EventArgs e)
    {
        ...
        if (sybll.Insert_kjpl(gyid, name, con) > 0)
        {
            sybll.Update_addkjpl(gyid);
