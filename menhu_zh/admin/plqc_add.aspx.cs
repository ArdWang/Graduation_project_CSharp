...
public partial class admin_plqc_add : System.Web.UI.Page
{
    ...
    {
        string sql = "select qcid from sy_qiche";
    ...
    protected void btnfb_Click(object sender, EventArgs e)
    {
        ...
        if (sybll.Insert_qcpl(gyid, name, con) > 0)
        {
            sybll.Update_addqcpl(gyid);
