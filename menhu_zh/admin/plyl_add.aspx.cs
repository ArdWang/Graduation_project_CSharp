...
public partial class admin_plyl_add : System.Web.UI.Page
{
    ...
    {
        string sql = "select yuleid from sy_yule";
    ...
    protected void btnfb_Click(object sender, EventArgs e)
    {
        ...
        if (sybll.Insert_ylpl(gyid, name, con) > 0)
        {
            sybll.Update_addylpl(gyid);
