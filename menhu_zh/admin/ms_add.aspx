<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ms_add.aspx.cs" Inherits="admin_ms_add" ValidateRequest="false"%>
...
<body>
    <form id="form1" runat="server">
       <div id="box">
        ...
        <div class="main">
            <div class="m_left">
                <div class="ml_top">美食管理</div>
                <div class="ml_con">
                   <ul>
                      <li><a href="admin_ms.aspx">美食首页</a></li>
            ...
            <div class="m_right">
               <div class="mr_top">美食内容添加</div>
               <div class="mr_con">
                  <div class="bt">
                      <div class="bt_top">标题</div>
                      <div class="bt_con">
                          <asp:TextBox ID="txtmsbt" runat="server" Width="400px" Height="40px"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="标题不能为空" Display="Dynamic" ControlToValidate="txtmsbt"></asp:RequiredFieldValidator>
                      </div>
                  </div>
                  <div class="nr">
                      <div class="nr_top">内容(必填)&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="内容不能为空" ControlToValidate="content1" Display="Dynamic"></asp:RequiredFieldValidator></div>
                      <div class="nr_con">
