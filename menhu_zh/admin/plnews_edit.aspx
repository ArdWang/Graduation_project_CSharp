<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="plnews_edit.aspx.cs" Inherits="admin_plnews_edit" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="left">
        <div class="l_top">新闻评论管理</div>
        <div class="l_con">
           <ul>
              <li><a href="plnews_add.aspx">评论发布</a></li>
              <li><a href="plnews_edit.aspx">评论编辑</a></li>
           </ul>
        </div>
    </div>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <div class="right">
       <div class="r_top">新闻评论编辑</div>
       <div class="r_con">
          <asp:GridView ID="grdxwpl" runat="server" AutoGenerateColumns="False" 
               onrowediting="grdxwpl_RowEditing" 
               onrowcancelingedit="grdxwpl_RowCancelingEdit" 
               onrowupdating="grdxwpl_RowUpdating" DataKeyNames="plnewsID" 
               onrowdeleting="grdxwpl_RowDeleting">
           <Columns>
               <asp:TemplateField HeaderText="评论文章ID">
                   <EditItemTemplate>
                       <asp:Label ID="lbid1" runat="server" Text='<%# Eval("newsID") %>'></asp:Label>
                   </EditItemTemplate>
                   <ItemTemplate>
                       <asp:Label ID="lbid" runat="server" Text='<%# Bind("newsID") %>'></asp:Label>
                   </ItemTemplate>
               ...
               <asp:TemplateField HeaderText="删除" ShowHeader="False">
                   <ItemTemplate>
                       <asp:LinkButton ID="lbtndel" runat="server" CausesValidation="False" 
                           CommandName="Delete" Text="删除" CommandArgument='<%# Eval("plnewsId") %>' 
