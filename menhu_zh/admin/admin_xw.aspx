<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="admin_xw.aspx.cs" Inherits="admin_admin_xw" validateRequest="false" %>
       ...
       <asp:GridView ID="grdnews" runat="server" AutoGenerateColumns="False">
           <Columns>
               ...
               <asp:TemplateField HeaderText="新闻标题">
                   <EditItemTemplate>
                       <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("newsTitle") %>'></asp:TextBox>
                   </EditItemTemplate>
                   <ItemTemplate>
                       <asp:Label ID="Label2" runat="server" Text='<%# Bind("newsTitle") %>'></asp:Label>
                   </ItemTemplate>
                   <ItemStyle CssClass="t2" />
               </asp:TemplateField>
               <asp:TemplateField HeaderText="新闻内容">
                   <EditItemTemplate>
                       <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("newsCon") %>'></asp:TextBox>
                   </EditItemTemplate>
                   <ItemTemplate>
               ...
               <asp:TemplateField HeaderText="新闻图片">
                   <EditItemTemplate>
                       <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("newsImg") %>'></asp:TextBox>
                   </EditItemTemplate>
                   <ItemTemplate>
               ...
               <asp:TemplateField HeaderText="发布人">
                   <EditItemTemplate>
                       <asp:TextBox ID="TextBox5" runat="server" Text='<%# Bind("newsFbren") %>'></asp:TextBox>
                   </EditItemTemplate>
                   <ItemTemplate>
               ...
               <asp:TemplateField HeaderText="发布时间">
                   <EditItemTemplate>
                       <asp:TextBox ID="TextBox6" runat="server" Text='<%# Bind("newsTime") %>'></asp:TextBox>
                   </EditItemTemplate>
                   <ItemTemplate>
               ...
               <asp:TemplateField HeaderText="评论">
                   <EditItemTemplate>
                       <asp:TextBox ID="TextBox7" runat="server" Text='<%# Bind("newspl") %>'></asp:TextBox>
                   </EditItemTemplate>
                   <ItemTemplate>
