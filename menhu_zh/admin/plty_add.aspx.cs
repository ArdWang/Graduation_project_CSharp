...
public partial class admin_plty_add : System.Web.UI.Page
{
    ...
    {
        string sql = "select tyid from sy_tiyu";
    ...
    protected void btnfb_Click(object sender, EventArgs e)
    {
        ...
        if (sybll.Insert_typl(gyid, name, con) > 0)
        {
            sybll.Update_addtypl(gyid);
