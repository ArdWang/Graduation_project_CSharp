...
public partial class admin_pljk_add : System.Web.UI.Page
{
    ...
    {
        string sql = "select jkid from sy_jiank";
    ...
    protected void btnfb_Click(object sender, EventArgs e)
    {
        ...
        if (sybll.Insert_jkpl(gyid, name, con) > 0)
        {
            sybll.Update_addjkpl(gyid);
