...
public partial class admin_plsx_add : System.Web.UI.Page
{
    ...
    {
        string sql = "select sxid from sy_shix";
    ...
    protected void btnfb_Click(object sender, EventArgs e)
    {
        ...
        if (sybll.Insert_sxpl(gyid, name, con) > 0)
        {
            sybll.Update_addsxpl(gyid);
