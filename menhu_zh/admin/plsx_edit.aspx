<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="plsx_edit.aspx.cs" Inherits="admin_plsx_edit" ValidateRequest="false" %>
...
<div class="left">
        <div class="l_top">时尚评论管理</div>
        <div class="l_con">
           <ul>
              <li><a href="plsx_add.aspx">评论发布</a></li>
              <li><a href="plsx_edit.aspx">评论编辑</a></li>
           </ul>
        </div>
    </div>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
   <div class="right">
       <div class="r_top">时尚评论编辑</div>
       <div class="r_con">
          <asp:GridView ID="grdgypl" runat="server" AutoGenerateColumns="False" 
               onrowediting="grdgypl_RowEditing" 
               onrowcancelingedit="grdgypl_RowCancelingEdit" 
               onrowupdating="grdgypl_RowUpdating" DataKeyNames="plsxID" 
               onrowdeleting="grdgypl_RowDeleting">
           <Columns>
               <asp:TemplateField HeaderText="评论文章ID">
                   <EditItemTemplate>
                       <asp:Label ID="lbid1" runat="server" Text='<%# Eval("sxID") %>'></asp:Label>
                   </EditItemTemplate>
                   <ItemTemplate>
                       <asp:Label ID="lbid" runat="server" Text='<%# Bind("sxID") %>'></asp:Label>
                   </ItemTemplate>
               ...
               <asp:TemplateField HeaderText="删除" ShowHeader="False">
                   <ItemTemplate>
                       <asp:LinkButton ID="lbtndel" runat="server" CausesValidation="False" 
                           CommandName="Delete" Text="删除" CommandArgument='<%# Eval("plsxId") %>' 
