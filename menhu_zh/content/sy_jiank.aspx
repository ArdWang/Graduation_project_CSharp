<%@ Page Title="" Language="C#" MasterPageFile="~/content/content.master" AutoEventWireup="true" CodeFile="sy_jiank.aspx.cs" Inherits="content_sy_jiank" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <div class="l_top">
       ...
       <div class="t_right">当前的位置：<a href="sy_jiank.aspx">首页</a></div>
   </div>
   <div class="l_con">
       <asp:Repeater ID="rptgy" runat="server">
        ...
        <ItemTemplate>
           <li class="l1">
               <asp:HyperLink ID="hylyl" runat="server" Text='<%# ziduanjq.Jq_xwbt1(Eval("jkTitle").ToString()) %>' NavigateUrl='<%# Eval("jkId","sy_jk_content.aspx?jk_id={0}") %>'></asp:HyperLink></li>
           <li class="l2">
               <asp:Label ID="lbtime" runat="server" Text='<%# Eval("jkTime") %>'></asp:Label>
           </li>
        </ItemTemplate>
