<%@ Page Title="" Language="C#" MasterPageFile="~/content/content.master" AutoEventWireup="true" CodeFile="sy_news_content.aspx.cs" Inherits="content_sy_news_content" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <link href="css/sy_gy.css" rel="stylesheet" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <div class="l_top">
       ...
       <div class="t_right">当前的位置：<a href="sy_news.aspx">首页</a>&nbsp;>&nbsp;新闻内容</div>
   </div>
   <div class="l_con1">
       <asp:Repeater ID="rptnews" runat="server" OnItemDataBound="rptnews_ItemDataBound">
        ...
        <ItemTemplate>
           <li class="ltop">
               <asp:Label ID="lbtitle" runat="server" Text='<%# Eval("newsTitle") %>'></asp:Label><li>
           <li class="ledit">
               编辑：<asp:Label ID="lbedit" runat="server" Text='<%# Eval("newsfbren") %>'></asp:Label></li>
           <li class="ltime">
               编辑时间：<asp:Label ID="lbtime" runat="server" Text='<%# Eval("newsTime") %>'></asp:Label></li>
           <li class="limg">
               <asp:Image ID="imgxy" runat="server" ImageUrl='<%# Eval("newsImg") %>' />
               <span class="imgzt"><asp:Label
                   ID="lbimg" runat="server" Text=""></asp:Label></span>
           </li>
           <li class="lcon">
               <asp:Literal ID="ltcon" runat="server" Text='<%# Eval("newsCon") %>'></asp:Literal></li>
           <li class="lpl">评论（<asp:Label ID="lbplnum" runat="server" Text='<%# Eval("newspl") %>'></asp:Label>）</li>
        </ItemTemplate>
   ...
   <div class="wz">
       <div class="wzxs">
           <asp:Repeater ID="rptgs" runat="server">
               <HeaderTemplate><ul></HeaderTemplate>
               <ItemTemplate>
                   <li><span class="zitixs">上一篇</span>：<asp:HyperLink ID="hylss" runat="server" Text='<%# ziduanjq.Jq_xwbtxs(Eval("newsTitle").ToString()) %>' NavigateUrl='<%# Eval("newsId","sy_news_content.aspx?xw_id={0}") %>'>
                       </asp:HyperLink><br/></li>
               </ItemTemplate>
               <FooterTemplate></ul></FooterTemplate>
           </asp:Repeater>
       ...
       <div class="wzxx">
           <asp:Repeater ID="rptgx" runat="server">
               <HeaderTemplate><ul></HeaderTemplate>
               <ItemTemplate>
                   <li><span class="zitixs">下一篇</span>：<asp:HyperLink ID="hylss1" runat="server" Text='<%# ziduanjq.Jq_xwbtxs(Eval("newsTitle").ToString()) %>' NavigateUrl='<%# Eval("newsId","sy_news_content.aspx?xw_id={0}") %>'>
                       </asp:HyperLink><br/></li>
               </ItemTemplate>
               <FooterTemplate></ul></FooterTemplate>
           </asp:Repeater>
   ...
   <div class="pl">
       ...
       <div class="pl_con">
           <asp:Repeater ID="rptpl" runat="server">
               ...
               <ItemTemplate>
                   <li>
                       <asp:Label ID="lbname" runat="server" Text='<%# Eval("plman") %>'></asp:Label>&nbsp;说：<asp:Literal ID="ltplcon" runat="server" Text='<%# Eval("plcon") %>'></asp:Literal>
                       </li>
               </ItemTemplate>
               <FooterTemplate></ul></FooterTemplate>
           </asp:Repeater>
   ...
   <div class="l_pl">
       <div class="p_top"><span class="plzt2">文章评论</span><span class="plzt1">(文明发言,为自己争光！)</span></div>
       <div class="p_con">
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <div class="right">
       ...
       <div class="r_con">
           <asp:Repeater ID="rptxw1" runat="server">
             <HeaderTemplate><ul></HeaderTemplate>
             <ItemTemplate>
                 <li>
                     <asp:HyperLink ID="hyplk1" runat="server" Text='<%# ziduanjq.Jq_xwbt2(Eval("newsTitle").ToString()) %>' NavigateUrl='<%# Eval("newsId","sy_news_content.aspx?xw_id={0}") %>'></asp:HyperLink></li>
             </ItemTemplate>
             <FooterTemplate></ul></FooterTemplate>
           </asp:Repeater>
       </div>
       ...
       <div class="r_con">
           <asp:Repeater ID="rptxw2" runat="server">
             <HeaderTemplate><ul></HeaderTemplate>
             <ItemTemplate>
                 <li>
                     <asp:HyperLink ID="hyplk2" runat="server" Text='<%# ziduanjq.Jq_xwbt2(Eval("newsTitle").ToString()) %>' NavigateUrl='<%# Eval("newsId","sy_news_content.aspx?xw_id={0}") %>'></asp:HyperLink></li>
             </ItemTemplate>
             <FooterTemplate></ul></FooterTemplate>
           </asp:Repeater>
       </div>
