<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sy_shouyexy.aspx.cs" Inherits="sy_shouyexy" %>
    ...
    <form id="form1" runat="server">
      <div id="box">
       <div class="head">
           <div class="h_left1">
               <ul>
                   <li><span class="hzt1">尊敬的</span>&nbsp;<span class="hlzt1"><asp:Label ID="lbname" runat="server" Text=""></asp:Label></span>&nbsp;<span class="hzt1">欢迎你的到来！</span>&nbsp;&nbsp;&nbsp;<asp:LinkButton ID="lbtnexit" runat="server" OnClick="lbtnexit_Click">退出</asp:LinkButton>&nbsp;&nbsp;<a href="xiugaizl.aspx">修改资料</a></li>
               </ul>
           </div>
                      ...
                      <asp:Repeater ID="rptty1" runat="server">
                          ...
                          <ItemTemplate>
                              ...
                              <li class="tyl2"><span class="tyzt1">
                                  <asp:HyperLink ID="hylty" runat="server" Text='<%# ziduanjq.Jq_tybt(Eval("tyTitle").ToString()) %>' NavigateUrl='<%# Eval("tyId","content/sy_tiyu.aspx?ty_id={0}") %>'></asp:HyperLink></span><br/><span class="tyzt2"><asp:Literal ID="ltty" runat="server" Text='<%# ziduanjq.Jq_tyCon(Eval("tyCon").ToString()) %>'></asp:Literal></span></li>
                          </ItemTemplate>
                          <FooterTemplate></ul></FooterTemplate>
                      </asp:Repeater>
                  </div>
